...
public class ChatListServlet extends HttpServlet {
    private final static Logger log = Logger.getLogger(ChatListServlet.class.getName());
    ...
    public String getToday() {
        ...
        for (int i = 0; i < chatList.size(); i++) {
            ...
            result.append("{\"value\": \"" + chatList.get(i).getChatTime().substring(0, 19) + "\"}]");
    ...
    public String getID(String chatID) {
        ...
        //Logger log = Logger.getLogger(ChatListServlet.class.getName());
        //log.addAppender(new ConsoleAppender(new PatternLayout()));
        //log.fatal(chatList.size() - 1);
        if(chatList.size() == 0) {
            return "";
        }
